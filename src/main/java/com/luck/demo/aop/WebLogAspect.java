...
public class WebLogAspect {
     ...
     * //
     */
    @Pointcut("execution(public * com.luck.demo.controller.userController.queryUser(..))")
    public void webLogPointcut() {
    }

//    @Around("execution(public * com.luck.demo.controller.Send.*(..))")
